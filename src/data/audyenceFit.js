...
export const REQS = [
  // ── The role (hero) — its dossier is the four-quadrant operator map ──────────
  {
    ...
    quadrants: [
      ...
      },
      {
        ...
        body: 'McCombs M.S. in Marketing, HubSpot certified, AI search strategy for Frozen Garden, a live DTC client.',
      },
      {
        fn: 'Customer Success',
  ...
  // ── Key Responsibilities ("do") ─────────────────────────────────────────────
  {
    ...
    built: ['treyleases.com', 'Follow Up Boss CRM', 'daily ops automation'],
    receipts: [
  ...
  },
  {
    ...
    built: ['Follow Up Boss API', 'Demandbase capstone', 'lifecycle automation'],
    receipts: [
  ...
  },
  {
    ...
    help: "My model is spotting the repetitive manual step and turning it into an agent. At Epicor I turned a manual monitoring process into a reusable format the marketing and PR teams ran with.",
    built: ['Epicor insight system', 'ops automation pipeline', "personal AI OS"],
    receipts: [
  ...
  },
  {
    ...
    built: ['Python inventory ETL', 'Demandbase capstone', 'treyleases data layer'],
    receipts: [
      'Python ETL normalizes 800+ listings across 9 sources into one layer',
  ...
  },
  {
    ...
    help: "I build internal tooling because I’m the revenue team using it: a daily ops dashboard, automated tour prep summaries, an inventory and pricing-pressure view, automated drafting.",
    built: ['daily ops dashboard', 'automated tour prep', 'treyleases'],
    receipts: [
  ...
  },
  {
    ...
    built: ['treyleases exposure contract', 'personal finance ledger'],
    receipts: [
      'Exposure contract keeps private fields server-side on treyleases',
      'Append-only ledger + reconciliation in the personal finance system',
    ],
  },
  {
    id: 'do-08',
    ...
    built: ['Python ETL rebuild', 'treyleases', 'Follow Up Boss ops'],
    receipts: [
  ...
  },
  {
    ...
    built: ['Epicor C-suite delivery', 'Demandbase exec deck', 'B2B product spec'],
    receipts: [
      'Built dashboards from scratch, presented to the Chief Communications Officer',
      'Turned model output into a value calculator + exec deck for a real B2B client',
    ],
  },
  ...
  // ── Qualifications ("bring") ─────────────────────────────────────────────────
  {
    ...
    built: ['treyleases (shipped solo)', 'Demandbase capstone', "personal AI OS"],
    receipts: [
  ...
  },
  {
    ...
    help: "I haven’t run Zapier or Workato by name, but I’ve done the integration work by hand: the Follow Up Boss API end to end, a Python ETL orchestrator, an MCP-integrated agent stack.",
    built: ['Follow Up Boss API', 'Python ETL orchestrator', 'MCP integrations'],
    receipts: [
  ...
  },
  {
    ...
    highlights: ['HubSpot'],
    help: "Honest read: my thinnest named-tool area. I’m HubSpot certified but haven’t built journeys in Marketo or Pardot; lifecycle-triggered drafts and reminders already run in my ops.",
    built: ['HubSpot (certified)', 'lifecycle automation', 'Follow Up Boss action plans'],
    receipts: [
  ...
  },
  {
    ...
    help: 'Squarely my lane. I run a production Python ETL pipeline across nine brokerages; the capstone added temporal joins, a percentile scoring framework, and ML on 422K rows.',
    built: ['Python inventory ETL', 'Demandbase capstone', 'ML classification (422K rows)'],
    receipts: [
  ...
  },
  {
    ...
    help: 'The through-line of everything I build: a SaaS concept for leasing agents became a full product spec, the capstone turned a scoring need into a production script, treyleases turned “I need leads” into a system.',
    built: ['leasing agent SaaS spec', 'Demandbase value calculator', 'treyleases'],
    receipts: [
