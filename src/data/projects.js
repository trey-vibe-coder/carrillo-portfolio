export const projects = {
  ...
  resources: {
    ...
    items: [
      ...
      { name: 'Resume', desc: 'View my current resume.', links: [{ label: 'Open Resume', url: 'https://drive.google.com/file/d/1QGckh_xOPsZ8DE-q_czcPtEgG_RrcHXs/view?usp=sharing' }] }
    ]
  }
};

export const fileColors = {
  analytics: ['#3b82f6', '#60a5fa'],
  strategy: ['#8b5cf6', '#a78bfa'],
  extra: ['#f59e0b', '#fbbf24'],
  resources: ['#10b981', '#34d399']
};

export const fileExtLabels = {
  analytics: 'DATA',
  strategy: 'DECK',
  extra: 'DOC',
  resources: 'LINK'
