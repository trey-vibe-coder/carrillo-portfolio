          ...
          <div className="home-nav-buttons">
            ...
            <div style={{ position: 'relative' }}>
              <a
                ...
                rel="noopener noreferrer"
                onClick={handleNavClick}
                style={{ position: 'absolute', bottom: '100%', left: '50%', transform: 'translateX(-50%)', marginBottom: '6px', display: 'flex' }}
              >
                <svg viewBox="0 0 98 96" style={{ width: '28px', height: '28px', fill: '#000000' }} xmlns="http://www.w3.org/2000/svg">
