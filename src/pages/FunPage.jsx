...
const stars = [
  ...
  {
    href: 'https://www.linkedin.com/in/angeltreycarrillo/',
    label: 'LinkedIn',
    className: 'linkedin',
    size: 'size-linkedin',
    svgPath: 'M12 2 L15 9 L22 9 L17 14 L19 22 L12 18 L5 22 L7 14 L2 9 L9 9 Z',
    fill: '#0A66C2',
    spinDuration: '19s',
    textSpinDuration: '17s',
    duration: '37s',
    fx: ['25vw', '-25vw', '35vw', '-15vw'],
    fy: ['25vh', '-35vh', '15vh', '35vh'],
    desc: 'Where I keep it professional.',
  },
  {
